...
% crude way using the final two data points as follows:
...
% regression, to get a "line of best fit" using more of the data points.
% That might be more appropriate if the error plots were less clean than 
% they are for this example.
